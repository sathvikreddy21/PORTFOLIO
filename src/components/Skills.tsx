...
const skills = [
  { 
    category: "Frontend", 
    items: ["React.js", "Angular", "TypeScript", "JavaScript", "HTML5", "CSS3", "Bootstrap", "SwiftUI"] 
  },
  { 
    category: "Backend", 
    items: ["Java", "Spring Boot", "Node.js", "Express.js", "REST APIs", "GraphQL", "Kafka", "Microservices"] 
  },
  { 
    category: "DevOps & Cloud", 
    items: ["AWS", "Azure", "GCP", "Docker", "Kubernetes", "Jenkins", "Terraform", "CI/CD"] 
  },
  { 
    category: "Databases", 
    items: ["MySQL", "PostgreSQL", "MongoDB", "DynamoDB", "Redis", "Elasticsearch", "Oracle"] 
  },
  { 
    category: "AI & ML", 
    items: ["AWS Bedrock", "LangChain", "RAG", "LLMs", "MCP", "Generative AI", "Semantic Search"] 
  },
  { 
    category: "Languages", 
    items: ["Java", "Python", "JavaScript", "TypeScript", "Swift", "SQL", "Scala", "Bash"] 
  },
];
