...
const projects = [
  {
    ...
    title: "HydroForce",
    category: "Web App",
    description: "Hydration accountability app with persistent reminders that can't be dismissed until water intake is logged.",
    longDescription: "HydroForce is a hydration accountability web application that encourages users to drink water through persistent reminders. Instead of allowing reminders to be ignored, the app continues alerting users until they record their water intake, helping build consistent hydration habits.",
    techStack: ["React", "Node.js", "Notifications API", "JavaScript"],
    repo: "https://github.com/sathvikreddy21/HydroForce",
    demo: "",
    color: "from-blue-600/20 to-cyan-500/20",
    hoverColor: "group-hover:from-blue-600/40 group-hover:to-cyan-500/40",
    span: "md:col-span-2 md:row-span-2",
    mediaUrl: "https://images.pexels.com/photos/416528/pexels-photo-416528.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    demoUrl: "https://images.pexels.com/photos/1000084/pexels-photo-1000084.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
  },
  {
    id: "hydroforce-mobile",
    title: "HydroForce Mobile",
    category: "Android • Kotlin",
    description: "Native Android hydration reminder app with persistent notifications requiring confirmation of water consumption.",
    longDescription: "HydroForce Mobile is a hydration reminder app built with Kotlin. It sends persistent notifications, tracks water intake, and encourages users to maintain healthy hydration habits by requiring confirmation of water consumption.",
    techStack: ["Kotlin", "Android", "Push Notifications", "Room DB"],
    repo: "https://github.com/sathvikreddy21/HydroForceMobile",
    demo: "",
    ...
    demoUrl: "https://images.pexels.com/photos/1092644/pexels-photo-1092644.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
  },
  {
    id: "tamil-hindi-qa",
    title: "Tamil & Hindi QA System",
    category: "NLP • Machine Learning",
    description: "Multilingual question-answering system processing queries in Tamil and Hindi, returning answers in both the original language and English.",
    longDescription: "An NLP-based multilingual question-answering system that processes questions in Tamil and Hindi using machine translation and state-of-the-art language models. The project translates queries, predicts relevant answers, and returns responses in the original language as well as English, helping bridge language barriers through bilingual natural language processing.",
    techStack: ["Python", "Transformers", "HuggingFace", "NLP", "Machine Translation"],
    repo: "https://github.com/sathvikreddy21/https-github.com-HemanthReddy09-Tamil-and-Hindi-question-answering",
    demo: "",
    color: "from-orange-500/20 to-red-500/20",
    hoverColor: "group-hover:from-orange-500/40 group-hover:to-red-500/40",
    span: "md:col-span-3 md:row-span-1",
    mediaUrl: "https://images.pexels.com/photos/267669/pexels-photo-267669.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    demoUrl: "https://images.pexels.com/photos/256417/pexels-photo-256417.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
  },
];
